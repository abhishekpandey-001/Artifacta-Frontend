...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "0fd13ed8-45e1-4895-b47e-e228401a60b9");
    ...
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-12  max-w-80 mx-auto'>Looking to Style Your Space? Let’s Create Something Beautiful</p>
